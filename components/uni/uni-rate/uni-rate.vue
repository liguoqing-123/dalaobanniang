<template>
	<view>
		<view ref="uni-rate" class="uni-rate">
			<view class="uni-rate__icon" :style="{ 'margin-right': margin + 'upx' }" v-for="(star, index) in stars" :key="index" @touchstart.stop="touchstart" @touchmove.stop="touchmove">
...
<script>
	 ...
	 * @property {Number} 	margin 						星星的间距，单位 upx
